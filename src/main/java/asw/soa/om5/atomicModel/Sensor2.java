    ...
    protected void deltaExternal(Double e, Object value) {
        ...
        if (this.phase.getName().equals("DETECT")) {
            if (this.activePort == in_MOVE_RESULT) {
                ...
                //System.out.println("--" + this.modelName+" --Receive MSG: "+currentPos.toString() + ", SimTime: " + this.simulator.getSimulatorTime());
                ...
                if (ent.belong != currentPos.belong) {
                    ...
                    //System.out.println("--" + this.modelName+" --Receive MSG: "+target.toString() + ", SimTime: " + this.simulator.getSimulatorTime());
                }
